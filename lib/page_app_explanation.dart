        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _sectionTitle('5. 광고 안내'),

              _bodyText(
                '무료 버전에서는 배너 광고와 전면 광고가 표시될 수 있습니다. '
                '전면 광고는 저장/백업 같은 작업이 완료된 뒤, 자연스러운 흐름에서만 표시됩니다.'
              ),

              _bodyText(
                '또한 “응원하기”를 선택한 경우에만 보상형 광고가 표시될 수 있습니다. '
                '응원하기는 선택 사항이며, 광고를 보지 않아도 모든 기능은 동일하게 사용할 수 있습니다.'
              ),

              _bodyText(
                '광고 없이 사용하고 싶으신 경우 유료 구독을 통해 광고 제거 및 '
                '프로필 제한 해제가 가능합니다.'
              ),
